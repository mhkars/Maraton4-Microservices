...
import static com.halit.exception.ErrorType.BAD_REQUEST_ERROR;
import static com.halit.exception.ErrorType.KULLANICI_ZATEN_KAYITLI;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitichException(ProductServiceException ex){
